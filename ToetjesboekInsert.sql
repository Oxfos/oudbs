...
/* Opmerking: 
 * de (verplichte) volgnr-kolom wordt automatisch gevuld via een trigger.
 * Omdat de values-lijst nu niet alle kolommen omvat, is opname van een  
 * kolommenlijst na de tabelnaam verplicht.
 */
