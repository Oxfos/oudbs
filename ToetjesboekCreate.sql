 ...
 * (met stored procedure en triggers voor 
 * automatische berekening van energiePP)
...
--
-- trigger voor automatische berekening en invulling 
-- van een nieuw Ingredient.volgnr
--
