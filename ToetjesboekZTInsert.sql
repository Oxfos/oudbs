/* 
 * Insert-script voor ToetjesboekZT (versie zonder triggers)
...
insert into Ingredient values ('Coupe Kiwano',    'ijs',       0.15, 1);
insert into Ingredient values ('Coupe Kiwano',    'kiwano',     0.5, 2);
insert into Ingredient values ('Coupe Kiwano',    'slagroom',   0.3, 3);
insert into Ingredient values ('Coupe Kiwano',    'suiker',      10, 4);
insert into Ingredient values ('Coupe Kiwano',    'tequila',      1, 5);
insert into Ingredient values ('Glace Terrace',   'ijs',        0.2, 1);
insert into Ingredient values ('Glace Terrace',   'aardbeien',   50, 2);
insert into Ingredient values ('Glace Terrace',   'pernod',       2, 3);
insert into Ingredient values ('Glace Terrace',   'peper',     null, 4);
insert into Ingredient values ('Mango Plus Plus', 'mango',      0.5, 1);
insert into Ingredient values ('Mango Plus Plus', 'aardbeien',   50, 2);
insert into Ingredient values ('Mango Plus Plus', 'zure room',  0.4, 3);
